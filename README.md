...
- [Advertising Imagery Agent](./advertising-imagery-agent/) - A premium advertising imagery skill for photoreal product image sets, consistent multi-angle photoshoots, and lifestyle or human campaign visuals driven by painpoints.
...
- [Elite Engineering](./elite-engineering/) - A high-bar engineering discipline for architectural fit, simple optimized implementations, strong error handling, dead-code removal, maintainability, and right-sized validation.
- [Marketing And Advertising Agent](./marketing-and-advertising-agent/) - A painkiller-first conversion marketing skill for research, positioning, offers, funnels, ad concepts, copy, visual direction, experimentation, and profitable growth.
